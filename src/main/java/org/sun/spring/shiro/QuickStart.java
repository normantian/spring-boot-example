...
//
    ...
    public void run2() {
        ...
        UsernamePasswordToken token = new UsernamePasswordToken("admin", "567890");
...
//        Assert.isTrue(subject.hasRole("admin"));
        ...
        subject.checkPermission("guest:read");
        ...
        try {
            ...
            log.info("Subject was NOT allowed to execute method ");
        }
